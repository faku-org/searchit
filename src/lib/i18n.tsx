...
const en = {
  ...
  "settings.ocrQuality": "Scene text OCR",
  "settings.highQualityOcr": "High-quality OCR (better bib/plate numbers)",
  "settings.highQualityOcrHint": "Only takes effect on hardware with a capable GPU (8GB+ VRAM) or Apple Silicon (16GB+ unified memory) -- otherwise the fast tier keeps running. Downloads a one-time ~6.8GB model on the first photo processed after enabling.",
  ...
  "developer.config": "Configuration",
  "developer.watchDir": "Watch folder",
  "developer.previewDir": "Preview folder",
  "developer.faceThumbnailDir": "Face thumbnail folder",
  "developer.dbDir": "Database folder",
  "developer.dbDirExternal": "External Postgres (DATABASE_URL)",
  "developer.inferenceUrl": "Inference service",
  "developer.ocrStatus": "Scene text OCR",
  "developer.ocrDownloading": "Downloading/loading DeepSeek-OCR-2 (~6.8GB, one-time)…",
  "developer.ocrActiveCuda": "Using DeepSeek-OCR-2 (GPU)",
  "developer.ocrActiveMps": "Using DeepSeek-OCR-2 (Apple Silicon)",
  "developer.ocrNativeCapable": "Using fast OS-native tier (high-quality OCR not enabled)",
  "developer.ocrNativeIncapable": "Using fast OS-native tier (hardware doesn't meet the high-quality OCR requirements)",
...
const es: Record<TranslationKey, string> = {
  ...
  "settings.ocrQuality": "OCR de texto en escena",
  "settings.highQualityOcr": "OCR de alta calidad (mejores números de dorsal/patente)",
  "settings.highQualityOcrHint": "Solo tiene efecto en hardware con GPU capaz (8GB+ VRAM) o Apple Silicon (16GB+ de memoria unificada) -- si no, sigue usando el tier rápido. Descarga un modelo de ~6.8GB (una sola vez) en la primera foto procesada después de activarlo.",
  ...
  "developer.config": "Configuración",
  "developer.watchDir": "Carpeta vigilada",
  "developer.previewDir": "Carpeta de previews",
  "developer.faceThumbnailDir": "Carpeta de miniaturas de caras",
  "developer.dbDir": "Carpeta de base de datos",
  "developer.dbDirExternal": "Postgres externo (DATABASE_URL)",
  "developer.inferenceUrl": "Servicio de inferencia",
  "developer.ocrStatus": "OCR de texto en escena",
  "developer.ocrDownloading": "Descargando/cargando DeepSeek-OCR-2 (~6.8GB, una sola vez)…",
  "developer.ocrActiveCuda": "Usando DeepSeek-OCR-2 (GPU)",
  "developer.ocrActiveMps": "Usando DeepSeek-OCR-2 (Apple Silicon)",
  "developer.ocrNativeCapable": "Usando el tier nativo rápido (OCR de alta calidad no activado)",
  "developer.ocrNativeIncapable": "Usando el tier nativo rápido (el hardware no cumple los requisitos de OCR de alta calidad)",
