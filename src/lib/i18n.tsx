...
const en = {
  ...
  "settings.capabilities": "Optional features",
  "settings.faceRecognition": "Face recognition (identity matching)",
  "settings.visualSearch": "Visual & text search",
  "settings.capabilitiesHint": "Turning a feature back on only applies to new photos. To fill it in for existing ones, use \"Reprocess\" on those photos.",
...
const es: Record<TranslationKey, string> = {
  ...
  "settings.capabilities": "Funciones opcionales",
  "settings.faceRecognition": "Reconocimiento facial (identificación de personas)",
  "settings.visualSearch": "Búsqueda visual y por texto",
  "settings.capabilitiesHint": "Volver a activar una función solo aplica a fotos nuevas. Para completarla en fotos existentes, usá \"Reprocesar\" en esas fotos.",
