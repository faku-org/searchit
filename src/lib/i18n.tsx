...
const en = {
  ...
  "newEvent.categorySports": "Sports (prioritize bib numbers)",
  "newEvent.categoryVacation": "Vacation (prioritize faces)",
  "newEvent.categoryGeneral": "General",
  "newEvent.categoryCustom": "Custom weights",
  "newEvent.customOcrConfidence": "OCR confidence threshold",
  "newEvent.customOcrConfidenceHint":
    "Lower catches more text but noisier (good for hard-to-read bib numbers); higher keeps only clean, confident text.",
  "newEvent.customFaceMatchDistance": "Face match distance",
  "newEvent.customFaceMatchDistanceHint":
    "Lower only links faces that are a very close match; higher groups people together more loosely.",
  "events.empty": "No events yet.",
  "events.editMode": "Edit mode",
  "events.applyMode": "Apply mode",
  "events.applying": "Applying…",
  "events.updated": "Event updated.",
  "events.reprocessQueuedOne": "Mode updated -- reprocessing {count} photo with the new weights.",
  "events.reprocessQueuedOther": "Mode updated -- reprocessing {count} photos with the new weights.",
...
const es: Record<TranslationKey, string> = {
  ...
  "newEvent.category": "Categoría",
  "newEvent.categorySports": "Deportivo (prioriza números de dorsal)",
  "newEvent.categoryVacation": "Vacacional (prioriza caras)",
  "newEvent.categoryGeneral": "General",
  "newEvent.categoryCustom": "Pesos personalizados",
  "newEvent.customOcrConfidence": "Umbral de confianza OCR",
  "newEvent.customOcrConfidenceHint":
    "Más bajo detecta más texto pero más ruidoso (útil para dorsales difíciles de leer); más alto deja solo texto limpio y confiable.",
  "newEvent.customFaceMatchDistance": "Distancia de coincidencia facial",
  "newEvent.customFaceMatchDistanceHint":
    "Más bajo solo vincula caras muy parecidas; más alto agrupa personas de forma más laxa.",
  "events.empty": "Todavía no hay eventos.",
  "events.editMode": "Editar modo",
  "events.applyMode": "Aplicar modo",
  "events.applying": "Aplicando…",
  "events.updated": "Evento actualizado.",
  "events.reprocessQueuedOne": "Modo actualizado -- reprocesando {count} foto con los nuevos pesos.",
  "events.reprocessQueuedOther": "Modo actualizado -- reprocesando {count} fotos con los nuevos pesos.",
